...
namespace practice_8
{
    internal class Program
    {
            ...
            /* тёмный маг */
        {
            ...
            {
                Console.WriteLine("Он видит, ты имеешь достаточно жизненных сил, чтобы совершить с ним сделку, пожертвовать 10 твоего здоровья на 2 зелья и 5 стрел. Что скажешь?\n1 - да, давай, я готов\n2 - ты чего, ни в коем случае");
                string choice = Console.ReadLine();
                switch (choice)
                {
                    case "1":
